  ...
  return (
    <section className="space-y-12">
      <header className="space-y-1">
        <h2 className="text-[28px] font-semibold tracking-tight">Employer Dashboard</h2>
        <p className="text-[13px] text-[var(--apple-text-secondary)]">Manage search, bookings & payments</p>
      </header>
      <Card variant="soft" className="p-6 space-y-5">
        <CardHeader title="Find a worker" subtitle="Search by skill or job name" />
